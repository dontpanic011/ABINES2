...
# Synchtube Premium © 2016-2018 by ZimnyLech

# ABOUT
_______

# Synchtube Premium is a powerful JavaScript application for Synchtube (or any server based on CyTube API) channels
...
# Relatively small filesize - less than 310 kB of code
...
FaviconURL		= 'https://files.catbox.moe/c56th7.png';

ChannelName		= 'Abines';

MiniLogoURL		= 'https://files.catbox.moe/oufig4.png';

CustomWelcomeText	= 'Bem-vindo';
...
// <img src="https://files.catbox.moe/fzk81i.png" width=50></img> <font size=3> Synch Awards 2017: <a href="http://poal.me/tb738" target="_blank">Vote aqui.</a> 
// Script atualizado (novo comando !fortune). Mudança de datas e horários: <a href="https://55chan.org/tv/res/14587+50.html" target="_blank">Veja no fio</a>.

JoinMessage		= 'VOLTO';

LeaveMessage		= 'VAI VOLTA';
...
CustomFooterHTML	= 'AUMENTANDO NOSSO CURRICULO OTACU';

AnswersArray		= [
	'Sim', 'Não', 'Pergunte outra vez', 'Só de vez enquando', 'Só se não chover', 'Não vou responder', '50%', 'Não sei', 'Às vezes sim, às vezes não', 'Ah, não precisava nem perguntar, você já sabe a resposta .perdi', 'Arrume seu quarto primeiro, depois eu respondo .jordan', 'E o seu quarto, já arrumou? .jordan2', 'E a pia cheia de pratos? .jordan3','Provavelmente' , 'E eu com isso?', '100% garantido','Você só descobrirá quando sair de casa', 'Você está perto de descrobrir isso sozinho','Então, meu patrão','Xiiiii', 'Se você soubesse a verdade, ficaria enojado', 'A verdade é que **THEGAME**' , 'Tô nem aí .dan3', 'Pode ser', 'Mais tarde respondo', '!rapaz .rapaz2' , 'Quer mesmo saber?', 'E se a resposta custasse tudo o que você acredita? .redpill3', 'Mais ou menos'
];

FortunesArray		= [
	'Doença grave',
	'Recuperação do controle da vida',
	'Feijoada',
	'Churrasco no banheiro',
	'Você irá para o mundo',
	'Você vai virar streetneet',
	'Você vai sair do chan para sempre',
	'Nova motivação',
	'Novo emprego',
	'Você será banido',
	'Seu filme sará o próximo do synch',
	'Perdeu o jogo',
	'Vai tirar duplos',
	'Você vai transar',
	'Xiii...'
...
'!golpe':'https://files.catbox.moe/dgrza7.ogg',
'!faleceu' : 'https://www.myinstants.com/media/sounds/faliceu-maguila.mp3',
...
'allah akbar': 'https://dl.dropboxusercontent.com/u/108079623/synch/allahakbar.m4a',
...
'anon2kappa': 'https://dl.dropboxusercontent.com/s/fa8mmtleanafo5o/akak.mp3',
'!aleluia': 'https://files.catbox.moe/k3a3oc.mp3',
'!corre': 'https://files.catbox.moe/dl1ec8.mp3',
'!caradela': 'https://files.catbox.moe/5j65sh.mp3',
...
'!deus': 'https://files.catbox.moe/9opf27.mp3',
'!ufo': 'https://files.catbox.moe/ln1a1b.mp3',
'!treina': 'https://files.catbox.moe/90ymsu.mp3',
'!merece': 'https://files.catbox.moe/24lnq5.mp3',
'BLAMM': 'https://dl.dropboxusercontent.com/s/kyo9dw3ov4t0msx/BLAM.mp3',
'anon2kappaa': 'https://dl.dropboxusercontent.com/s/uk0pwd36kmu9xwf/weebwow.mp3',
'djrobotxx': 'https://dl.dropboxusercontent.com/s/80cedjfb37fq37c/robot.mp3',
'!stfu': 'https://dl.dropboxusercontent.com/s/uio3nr398kyrgfv/stfuyoucunt.m4a',
...
'double kill': 'https://dl.dropboxusercontent.com/s/5lx58ipw9mkjzlz/doublekill.mp3',
'triple kill': 'https://dl.dropboxusercontent.com/s/tjcnx65d7fd77o3/triplekill.mp3',
'ludicrous kill': 'https://dl.dropboxusercontent.com/s/bg4tv859ha166b1/ludicrouskill.mp3',
'ultra kill': 'https://dl.dropboxusercontent.com/s/43xwupzfrv36v4b/ultrakill.mp3',
'multi kill': 'https://dl.dropboxusercontent.com/s/o1uylhjbyckkf56/multikill.mp3',
'monster kill': 'https://dl.dropboxusercontent.com/s/v8lz1xfnamiswml/monsterkill.mp3',
'!boomer': 'https://dl.dropboxusercontent.com/u/108079623/synch/boomer.mp3',
'!beleza' : 'https://files.catbox.moe/c3ajxn.mp3',
...
'!bestgames' : 'http://drowngaben.x10.mx/unused/gayniggas.mp3',
...
'dumbest cunt' : 'https://www.dropbox.com/s/k2um7a8l7hlv364/dumbest%20cunt.mp3?dl=1',
...
'!jordanpeterson' : 'https://files.catbox.moe/vy29ja.mp3',
'!kasino': 'https://www.myinstants.com/media/sounds/ae-kasinao_1.mp3',
'!mimde' : 'https://dl.dropboxusercontent.com/s/dccy7255bmk1g2p/me-de-papai.mp3',
'!maravilhoso': 'https://www.myinstants.com/media/sounds/ma-la-vi-lho-su.mp3',
'my leg!' : 'https://www.dropbox.com/s/1ydop17ur3njr11/my%20leg.mp3?dl=1',
'!nice2' : 'https://www.myinstants.com/media/sounds/joseph-joestar-nice.mp3' ,
'!no' : 'http://drowngaben.x10.mx/unused/no.mp3',
...
'!push2' : 'https://www.myinstants.com/media/sounds/bad-gay-porn-acting-4.mp3',
...
'!cocô' : 'https://files.catbox.moe/gx49oc.mp3',
'!quebom' : 'https://files.catbox.moe/29qwv7.mp3',
'!rapaz' : 'https://dl.dropboxusercontent.com/s/u9c20qu18i08ouq/rapaz.mp3',
'!vagabunda' : 'https://dl.dropboxusercontent.com/s/qys21iu3jhlvjag/vagabunda.mp3',
'!fogo' : 'https://dl.dropboxusercontent.com/s/zenh66g4ctso7mf/fogo.mp3',
'!viado' : 'https://dl.dropboxusercontent.com/s/yleklasgzjmm8lq/muitoviado.mp3',
'!acabou' : 'https://files.catbox.moe/ooy1nq.mp3',
'!xiii' : 'https://dl.dropboxusercontent.com/s/zplgf60dm2w4hvq/xiii.mp3',
'!uou' : 'https://files.catbox.moe/ly22p1.mp3',
'!caramba' : 'https://dl.dropboxusercontent.com/s/o1mt64ys6o9xfbs/caramba.mp3',
'!morre' : 'https://dl.dropboxusercontent.com/s/rpsvsq1wo1cadt2/morre.mp3',
'!dead' : 'https://dl.dropboxusercontent.com/s/0mnua2hubmdpcpo/morreu.mp3',
'!olavo1' : 'https://files.catbox.moe/jsjuqb.mp3',
'!olavo2' : 'https://files.catbox.moe/uedwgs.mp3',
'!pare' : 'https://dl.dropboxusercontent.com/s/7pc8fnn0mf06ja7/pare.mp3',
'!pancada' : 'https://dl.dropboxusercontent.com/s/b8k107sabw8378x/pancada.mp3',
'!pesadão' : 'https://files.catbox.moe/6sli3a.mp3',
'!pedra': 'https://www.myinstants.com/media/sounds/olha_a_pedra.mp3',
'!naoentendi' : 'https://dl.dropboxusercontent.com/s/6cvvf973tlahx5d/nao-entendi.mp3',
'!glória' : 'https://dl.dropboxusercontent.com/s/0iq7f0vn4e9wnmr/gloria.mp3',
'!eitamainha' : 'https://dl.dropboxusercontent.com/s/x0toflnur2xe6dy/eitamainha.mp3',
'!errou' : 'https://dl.dropboxusercontent.com/s/jje9tg1hfqup4ay/errou.mp3',
...
'!boça': 'https://files.catbox.moe/rabzws.mp3',
'!édeus': 'https://files.catbox.moe/bkpl7z.mp3',
'!juden': 'https://files.catbox.moe/fbd2vz.mp3',
'!não': 'https://files.catbox.moe/q38cas.mp3',
'!aipai': 'https://files.catbox.moe/j8m0u5.mp3',
'!bichona': 'https://files.catbox.moe/1uu5vr.mp3',
'!burro1': 'https://files.catbox.moe/u29vgq.mp3',
'!burro2' : 'https://files.catbox.moe/4zuezf.mp3',
...
'!spurdo' : 'https://resources.pink.horse/sounds/spurdo.ogg',
'thanks bitch' : 'https://www.dropbox.com/s/u2s1uhcdwlhyocd/thanks%20bitch.mp3?dl=1',
...
'!losco': 'https://files.catbox.moe/r736aj.mp3',
'!estilo' : 'https://files.catbox.moe/tp9cux.mp3',
'!naofaça': 'https://files.catbox.moe/z7brvy.mp3',
'!aimeudeus' : 'https://files.catbox.moe/56qdpk.mp3',
};

FactsArray		= [
    'é gay', 'curte pênis', 'quer dar o bumbum', 'suga caralhos', 'é fofinho :3',
	'é puro amorzinho :3', 'não sabe fazer nada direito', 'é cancroso',
	'suga caralhos', 'é um paneleiro', 'é redpilado', 'está bunda doída',
	'é federal', 'é um floquinho', 'vai dormir com o rabo quente', 'já comeu as empadas do Alex', 'dá o bumbum',
	'é um bom anão', 'precisa de um abraço', 'é alpha', 'roubou pão na casa do João', 'é petista', 'é adepto do federalismo', 'MATOU ROGÉRIO GASPAR', 'curte café', 'já beijou a moderadora', 'não sai do quarto há alguns dias', 'já derpou na padaria', 'tem o cu marrom', 'trabalha na PF','trabalha na ABIN', 'só entrou para shitpostar', 'é animefag', 'já seidou peido e ganhou mais', 'é apenas um novoamigo', 'pesca demais', 'já praticou banheirão', 'entrou no chan por causa do feto', 'é beta', 'perdeu o controle da vida', 'só entrou pra forçar alguns vídeos', 'tem ficha na abin' , 'tem uma bundinha de cetim',  'recebe o bolsa família', 'fica se passando por muié no salmão','estudou na FEBEM', 'reprovou no ENCEJA', 'é militante do DCE', 'já jogou truco valendo o toba', 'já comprou 50 reais de mussarela', 'usou cartão clonado sem VPN', 'é colunista da Folha', 'namora uma Mãe Solteira','vende brigadeiros na facool',
'dança o passinho do romano no rolê', 'é vitaminado', 'fecha com o Judeu', 'enfia objetos no bumbum', 'está samefaggeando duro', 'é noveleiro'
];
...
// Backwards compatibility - absolutely do not delete!

_ADDEDLINKS = getOrDefault('SP_addedlinks_' + CLIENT.name, '');
if (_ADDEDLINKS == "") {
	_ADDEDLINKS = getOrDefault('SP_addedlinks', '[]');
	if (_ADDEDLINKS != "[]") {
		var rnd = Math.random().toString();
		_ADDEDLINKS = _ADDEDLINKS.replace(/a>,<a/g, "a>" + rnd + "<a");
		var arr = _ADDEDLINKS.split(rnd);
		var _arr = [];
		for (i in arr) {
			var el = $(arr[i]);
			_arr.push({"link":el.attr('href'), "title":el.text()});
		}
		_ADDEDLINKS = JSON.stringify(_arr);
		setOpt('SP_addedlinks_' + CLIENT.name, _ADDEDLINKS);
	}
}

_CUSTOMFILTERS = getOrDefault('SP_customfilters_' + CLIENT.name, '');
if (_CUSTOMFILTERS == "") {
	var str = '[{"before":"synchtube","after":"Synchtube"}]';
	_CUSTOMFILTERS = getOrDefault('SP_customfilters', str);
	if (_CUSTOMFILTERS != str) {
		var arr = _CUSTOMFILTERS.split("\n");
		var _arr = [];
		for (i in arr) {
			if (arr[i] != "") {
				var fil = arr[i].split(" > ");
		...
		_CUSTOMFILTERS = JSON.stringify(_arr);
		setOpt('SP_customfilters_' + CLIENT.name, _CUSTOMFILTERS);
	}
}

_FAVLINKS = getOrDefault('SP_favlinks_' + CLIENT.name, '');
if (_FAVLINKS == "") {
	_FAVLINKS = getOrDefault('SP_favlinks', '[]');
	if (_FAVLINKS != "[]") {
		_FAVLINKS = JSON.stringify(JSON.parse(_FAVLINKS)["links"]);
		setOpt('SP_favlinks_' + CLIENT.name, _FAVLINKS);
	}
}

_MENTIONHISTORY = getOrDefault('SP_mentions_' + CLIENT.name, '');
if (_MENTIONHISTORY == "") {
	var _arr = [];
	_MENTIONS = getOrDefault('SP_mentionhistory_' + CLIENT.name, '');
	if (_MENTIONS.length > 0) {
		var rnd = Math.random().toString();
		_MENTIONS = _MENTIONS.replace(/span>,\/r\//g, "span>" + rnd + "/r/");
		var arr = _MENTIONS.split(rnd);
		arr = arr.reverse();
		for (i in arr) {
			var arr2 = arr[i].split(" → ");
			var arr3 = arr2[0].split(" · ");
			var arr4 = arr3[0].split("/r/");
			_arr.push({"room":arr4[1], "date":arr3[1], "msg":arr2[1]});
		}
	}
	_MENTIONS = JSON.stringify(_arr);
	setOpt('SP_mentions_' + CLIENT.name, _MENTIONS);
} else {
	var obj = JSON.parse(_MENTIONHISTORY);
	for (i in obj) {
		var d = obj[i].date.split("/");
		if (d[1].length < 2) d[1] = '0' + d[1];
		if (d[2].length < 2) d[2] = '0' + d[2];
		obj[i].date = d.join("/");
	}
	obj.sort(function(a, b) {return (a.date > b.date) ? 1 : ((b.date > a.date) ? -1 : 0)});
	setOpt('SP_mentions_' + CLIENT.name, JSON.stringify(obj));
}

_PLAYERHISTORY = getOrDefault('SP_playerhistory_' + CLIENT.name, '');
if (_PLAYERHISTORY == "") {
	_PLAYERHISTORY = getOrDefault('SP_playerhistory', '[]');
	if (_PLAYERHISTORY != "[]") {
		var rnd = Math.random().toString();
		_PLAYERHISTORY = _PLAYERHISTORY.replace(/a>,<a/g, "a>" + rnd + "<a");
		var arr = _PLAYERHISTORY.split(rnd);
		var _arr = [];
		for (i in arr) {
			var el = $(arr[i]);
			_arr.push({"link":el.attr('href'), "title":el.text()});
		}
		_PLAYERHISTORY = JSON.stringify(_arr);
		setOpt('SP_playerhistory_' + CLIENT.name, _PLAYERHISTORY);
	}
}

_SHORTHANDS = getOrDefault('SP_shorthands_' + CLIENT.name, '');
if (_SHORTHANDS == "") {
	_SHORTHANDS = getOrDefault('SP_shorthands', '[]');
	if (_SHORTHANDS != "[]") {
		_SHORTHANDS = JSON.stringify(JSON.parse(_SHORTHANDS)["codes"]);
		setOpt('SP_shorthands_' + CLIENT.name, _SHORTHANDS);
	}
}

_NOTES = getOrDefault('SP_notes_' + CLIENT.name, '');
if (_NOTES == "") {
	_NOTES = getOrDefault('SP_notes', '');
	if (_NOTES != "") setOpt('SP_notes_' + CLIENT.name, _NOTES);
}
...
CHATFONTSIZE	= getOrDefault('SP_chatfontsize',	105);
CHATMAXSIZE	= getOrDefault('SP_chatmaxsize',	200);
...
HIDEPLS		= getOrDefault('SP_hidepls',		true);
...
TTSLANGUAGE	= getOrDefault('SP_ttslanguage',	'pt');
...
CHATHIDESCROLL	= getOrDefault('SP_chathidescroll',	true);
CHATTOTOP	= getOrDefault('SP_chattotop',		true);
COLLAPSEMOTD	= getOrDefault('SP_collapsemotd',	false);
COLLAPSEULIST	= getOrDefault('SP_collapseulist',	true);
...
PREMIUMNOTMODE	= getOrDefault('SP_premiumnotmode',	2);
SEPARATEULIST	= getOrDefault('SP_separateulist',	false);
TABMODE		= getOrDefault('SP_tabmode',		1);
...
ColorsArray = [
	...
	'turquoise', 'limegreen', 'green', '#789922', 'darkkhaki', 'aqua', 'dodgerblue', 'blue', 'midnightblue',
	'darkslateblue',
];
...
function handleMediaChange() {
	if ($queue.find(".queue_entry").length > 0) {
		...
		if (['yt', 'sc', 'gd', 'fi'].indexOf(uid.type) > -1 && uid.duration != "00:00") {
			$("#pls-3").show();
			var arr = {
				'yt':	'https://www.vidpaw.com/?url=https://www.youtube.com/watch?v=',
				'sc':	'https://www.vidpaw.com/?url=',
...
function showImagesOnChat(elem) {
	elem.find(ImageExtensions).each(function() {
		var link = this.href;
		var block = false;
		if (link.indexOf("https://i.imgur.com") > -1) {
		...
		if (block) {
			$(this).html($(this).html() + ' [[bloqueado pelo imgur, clique para ver]]');
...
function playerMascot(mode) {
	if (mode == "hide") {
		...
		var arr = [
            ['Natal duro', 'https://i.imgur.com/ZAtFbSw.png'], 
		...
		MASCOTPOS = getOrDefault('SP_mascotpos', 'b-right');
...
// Warning! Remember to change all apostrophes in titles and names to \', to avoid conflict with database structure.
MediaDatabase = [

['', 'Início de sessão'],
['https://www.youtube.com/watch?v=bf-OwEmGKWk', 'Contagem regressiva'],
['https://www.youtube.com/watch?v=9uLEE0e0Hig', 'Spongebob in China'],
['https://www.youtube.com/watch?v=98UUYvMWoH0', 'Abertura Cine Trash'],
['https://drive.google.com/open?id=1vEH-iBMrPF223bIxBoN79KmblcrygRRp', 'O filme vai começar'],
['https://drive.google.com/open?id=14QXepxxceeefeBz1f1XV6CfVXQy91BIP', 'Universal'],

['', 'Festa Duro'],
['https://www.youtube.com/watch?v=RmTtCAk46EA', 'Magic Box @ Superpop'],
['https://www.youtube.com/watch?v=7w6v-W-3kuo', 'Kasinão no Boa Noite Brasil'],
['https://www.youtube.com/watch?v=xCHNJt6fEI4', 'Kasino com legendas'],
['https://www.youtube.com/watch?v=Twq92wtjRaE', 'Rave no Balanço Geral ES'],
['https://www.youtube.com/watch?v=jh5X5WJa3w0', 'Tony Garcia no Balanço Geral'],
['https://www.youtube.com/watch?v=oWqAf4eex14', 'jellyfish jam'],
['https://www.youtube.com/watch?v=gm5F1-kfaJ8', 'Laura Branigan -Self control'],
['https://www.youtube.com/watch?v=c_cCsFU6pak', 'Basshunter- Dota'],
['https://www.youtube.com/watch?v=_g5NDLKy0NI', 'Marc Rebillet'],
['', 'Fim de sessão'],
['https://www.youtube.com/watch?v=Q05fdsdAtes', 'Adult Swim Bump - I Should Be Dreaming'],
['https://www.youtube.com/watch?v=vyPkuPhBK5E', 'Adult Swim Bump - Go To Bed '],
['https://www.youtube.com/watch?v=u5NCQ20uzWY', 'Jesus do SBT'],
['https://www.youtube.com/watch?v=XdbRURP7OT0', 'Encerramento SBT'],
['https://www.youtube.com/watch?v=DsorqvBU-t0', 'Me Deixa'],
['https://files.catbox.moe/n1wkbf.mp4', 'Ferris Bueller - Cena Depois dos Créditos'],
['https://www.youtube.com/watch?v=s_eHTKuCkpc', 'Boa noite, meu consagrado'],

['', 'Etc'],
['https://www.youtube.com/watch?v=1fYsQGECi_U', 'Silvio Santos música Pião da Casa Própria no piano e assobiada'],
['https://www.youtube.com/watch?v=tRJTC1QfWyk', 'Sorteio Tele-sena'],
['https://www.youtube.com/watch?v=mRYf1JTJIEY', 'Credits - TimeSplitters: Future Perfect'],
['https://www.youtube.com/watch?v=uGJ4JiDVnMQ', 'Plantão Globo'],
['https://www.youtube.com/watch?v=3UuMspLxMGM', 'Contagem 1 minuto'],
['https://drive.google.com/open?id=0B9tk3tE4mDEMN1VTN3lkTUxtTnc', 'Problemas Técnicos'],

['', 'Bônus'],
['https://www.youtube.com/playlist?list=PLWwdmWvxFGHLs3tj2ScrEg5kMMwcSEJlR', 'Sealab 2021'],
...
if (hasPermission("settemp")) $(".add-temp").prop('checked', true);
...
$hidePlaylist = $('<span id="hide-playlist" class="label label-default pull-right pointer scroll-label" />')
  .attr('title', 'Hide playlist').appendTo($plmeta).html('<span class="glyphicon glyphicon-list"></span>');
...
var html = '<br />Channel powered by: <b>Synchtube Premium</b> v. ' + VERSION + ', Copyright © 2016-2018 ZimnyLech · '
...
$("#quality-menu").find("a").on("click", function() {
	...
	setOpt('default_quality', $(this).attr('val'));
	var text = USEROPTS.default_quality;
	if (text == "best") text = 'highest';
	$("#quality-btn").html('<span class="glyphicon glyphicon-film"></span> ' + text + ' ▾');
	if (!PLAYER || PLAYER.mediaType === undefined) return
	else {
		if (PLAYER.mediaType == "yt" || PLAYER.mediaType == "dm") {
			var txt = 'YouTube and Dailymotion resolution has to be changed directly on the player. '
				+ '\nCurrently there is no possibility to change it using external JavaScript code.';
			alert(txt);
		}
	}
	refreshPlayer();
	...
	if (msg.indexOf('!') == 0) {
		...
		if (msg.indexOf('!pick ') == 0) {
			...
			if (typeof FORTUNE !== "undefined") {
				COMMAND = false;
				addChatNotification('Você já leu a sua sorte');
			}
			if (COMMAND) {
			...
			if (len > 0) title = $(".queue_active").data("media").title
			else {
				if (CustomTitleCaption != "") title = $("#currenttitle").replace(CustomTitleCaption, "")
				else title = $("#currenttitle").replace("Currently Playing: ", "");
			}
			if (NowPlaying == "") NowPlaying = 'Now playing';
			...
			if (COMMAND) {
				...
				msg = UsersArray[Math.round(Math.random() * (UsersArray.length - 1))] + ' '
					...
					} else if (msg.indexOf('!filme ') == 0) {
    checkCommandsAbuse();
                if (COMMAND) {
                    var b = msg.split('!filme ')[1].split(',');
                    var b = parseInt(b);
                    var mySet = new Set();
                    if (b >= 5){
                do{
                    var num = Math.floor(Math.random() * b + 1);
                    var adicionar = mySet.add(num);
              ...
              let array = Array.from(mySet);
                      msg = array;
                            ...
                            msg = 'valor deve ser maior ou igual a 5'
                        }
                }
/*		} else if (msg.indexOf('!filme ') == 0) {
			checkCommandsAbuse();
...
addChatNotification('Script do glorioso Chanema v.' + VERSION + ' ativado (em ' + time + ' s.)');
